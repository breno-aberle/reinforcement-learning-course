...
def train(env_name, print_things=True, train_run_id=0, train_episodes=5000):
    ...
    for episode_number in range(train_episodes):
        ...
        while not done:
            ...
            # TODO (T2): Update the actor-critic code to perform TD(0) updates every 50 timesteps
            if (update_counter % 50 == 0 and update_counter > 0):
        ...
        if print_things:
            print("Episode {} finished. Total reward: {:.3g} ({} timesteps)".format(episode_number, reward_sum, timesteps))
        ...
        #agent.update_policy(episode_number) # TODO: for T1
